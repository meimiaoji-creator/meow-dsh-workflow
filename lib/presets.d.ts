 ...
 */
import type { AgentDef, AgentDefInput } from './schema.js';
/** 预置 6 角色定义（从插件根 agents.json 加载，键 = AgentDef.id；与运行时 agents.json 同构）。 */
export declare const PRESET_AGENTS: Record<string, AgentDefInput>;
/**
 ...
 */
export declare function ensurePresetAgents(root?: string): Promise<Record<string, AgentDef>>;
