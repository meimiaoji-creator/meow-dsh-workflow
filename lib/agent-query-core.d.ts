...
export declare const AGENT_LIST_TOOL = "meow_agent_list";
/** meow_agent_get 工具名（Agent 定义 allowedTools 授权项）。 */
export declare const AGENT_GET_TOOL = "meow_agent_get";
 ...
 */
export declare function listAgents(deps: AgentQueryDeps): Promise<AgentListItem[]>;
/**
 ...
 */
export declare function getAgent(deps: AgentQueryDeps, id: string): Promise<AgentListItem | undefined>;
